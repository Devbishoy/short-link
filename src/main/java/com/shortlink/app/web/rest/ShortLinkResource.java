...
public class ShortLinkResource {
	...
	/**
     * 
     * @param id is unique string identify short link
     * @param request
     * @param response
     * @return
     * @throws IOException
	...
	@GetMapping("/link/{id}")
	@Timed
	public RedirectView getOrignalURL(@PathVariable String id, HttpServletRequest request, HttpServletResponse response) throws IOException, URISyntaxException, Exception{
	...
	/**
     * 
     * @param urlDTO JSON contain URL and value is orignal URL or long URL 
     * @param request
     * @return
     */
	@PostMapping("/link")
